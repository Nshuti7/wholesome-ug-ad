...
export default function RevalidationPage() {
  ...
  const handleSingleRevalidation = async () => {
    ...
    try {
      ...
      // Call admin API route which handles token server-side
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "Failed to revalidate page");
      }
  ...
  const handleBulkRevalidation = async () => {
    try {
      ...
      if (!response.ok) {
        const errorData = await response.json().catch(() => ({}));
        throw new Error(errorData.error || "Failed to revalidate all pages");
      }
        ...
        <div className="flex-1 space-y-6 p-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Trigger Incremental Static Regeneration to update your website's static
              pages with fresh content from the backend
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  latest radio station data, programs, and team information
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Revalidate all radio station static pages at once
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    This will trigger revalidation for all radio station static pages. Use
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Quick Actions
                              ...
                              <CardDescription>
                  One-click revalidation for frequently updated radio station pages
                </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Dialog open={showBulkDialog} onOpenChange={setShowBulkDialog}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Are you sure you want to revalidate all radio station static pages? This
